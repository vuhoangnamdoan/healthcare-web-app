        ...
        stage('Test') {
            steps {
                ...
                withDockerRegistry(credentialsId: 'docker-creds', url: '') {
                    ...
                    sh "docker run --rm -e DJANGO_SETTINGS_MODULE=health_system.settings ${DOCKER_REGISTRY}/booking-backend:${BUILD_ID} pytest users/ appointments/ health_system/ --junitxml=reports/backend-tests.xml"
