        ...
        stage('Test') {
            steps {
                ...
                withDockerRegistry(credentialsId: 'docker-creds', url: '') {
                    ...
                    sh "docker run --rm -e DJANGO_SETTINGS_MODULE=health_system.settings -e PYTHONPATH=/app ${DOCKER_REGISTRY}/booking-backend:${BUILD_ID} pytest appointments/ users/ health_system/ --junitxml=reports/backend-tests.xml"
